...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                'name' => 'Hanasui Bright Up Facial Wash',
                'product_category_id' => 1,
                'price' => 25000,
                'description' => 'Facial wash dengan vitamin C untuk mencerahkan.',
                'weight' => 100,
                'stock' => 40,
            ],
            [
            ...
            [
                ...
                'product_category_id' => 3,
                'price' => 75000,
                'description' => 'Serum khusus jerawat.',
                'weight' => 50,
                'stock' => 35,
            ],
            [
                'name' => 'Skintific 10% Niacinamide Moisturizer',
